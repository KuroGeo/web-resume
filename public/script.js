...
const translations = {
  zh: {
    ...
    text: {
      ...
      "experience.edu.title": "信息工程本科",
      "experience.edu.subtitle": "华南理工大学",
      "experience.edu.body": "从计算机网络、操作系统和通信工程基础出发，逐步形成用工程视角拆解复杂系统的习惯。",
  ...
  en: {
    ...
    text: {
      ...
      "experience.edu.time": "2017 — 2021",
      "experience.edu.title": "B.Eng. in Information Engineering",
      "experience.edu.subtitle": "South China University of Technology",
      "experience.edu.body": "Built a foundation in computer networks, operating systems, and communication engineering, then gradually shaped an engineering-first way of breaking down complex systems.",
      ...
      "tag.networks": "Computer Networks",
      "tag.os": "Operating Systems",
      "tag.engineeringBasics": "Engineering Basics",
