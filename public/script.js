...
const translations = {
  ...
  en: {
    ...
    text: {
      ...
      "about.p3": "I want to keep building frontend products where I can own meaningful user flows, make the experience smoother, and improve the engineering foundation behind them.",
