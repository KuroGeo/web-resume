...
(function () {
  ...
  dialog.innerHTML = '<header class="portfolio-menu-header"><h2 id="portfolio-menu-title">Explore</h2><button class="portfolio-menu-close" type="button" aria-label="Close portfolio menu">×</button></header><div class="portfolio-menu-scroll" data-lenis-prevent><nav class="portfolio-menu-links" aria-label="Portfolio"><p class="micro">SELECTED WORK</p><div class="portfolio-menu-chapters"></div><button class="portfolio-menu-all" type="button">All Projects <span>' + SCROLLCAROUSEL_PROJECTS.length + ' projects ↗</span></button><a href="#resume-section" data-menu-section="resume">Résumé</a><a href="#contact" data-menu-section="contact">Contact</a></nav><div class="portfolio-menu-directory" hidden><button class="portfolio-menu-back" type="button">← Menu</button></div></div>';
